...
const createRange = (start, end, step = 1) => {
  ...
  if (typeof start !== "number") throw new Error("number is required");
  if (typeof end !== "number") throw new Error("number is required");
 ...
 * ]
 *
 * The function should return an array of usernames of users who have used more than 100 minutes of screentime for
 * a given date.
